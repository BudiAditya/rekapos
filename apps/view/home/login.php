...
<head>
	...
	<title>RekaPOS - User Login</title>
...
<div style="padding:50px;">
	<table align="center" width="100%" border="0" cellpadding="4" cellspacing="0">
		<td align="center">
			<img src="<?php print(base_url('logo.jpg'));?>" width="300" height="150">
		</td>
	</table>
	<div align="center">
		<h1 style="color: #0000FF">REKAPOS - INTEGRATED POS SYSTEM</h1>
	</div>
	<hr/>
	<form action="<?php echo site_url("home/login"); ?>" method="post" autocomplete="off">
		<table width="500" border="0" align="center" cellpadding="2" cellspacing="0">
			<tr>
				<td class="text4">Cabang/Outlet</td>
			...
			<tr>
				<td class="text4">Nilai Captcha</td>
	...
	<div class="text1" align="center">Permintaan bantuan hubungi : 0431 719 1129, 0812 4413 8229, 0811 431 9858 atau mgm@rekasys.com</div>
	<div class="text2" align="center">Copyright &copy; 2018 - 2019  PT REKA SISTEM TEKNOLOGI</div>
	<?php if (isset($error)) { ?>
	<script type="text/javascript">
