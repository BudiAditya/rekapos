...
<div style="padding:50px;">
	<table align="center" width="100%" border="0" cellpadding="4" cellspacing="0">
		<td align="center">
			<img src="<?php print(base_url('logo.jpg'));?>" width="420" height="200">
		</td>
	</table>
	<div align="center">
		<h1 style="color: #0000FF">REKAPOS - INTEGRATED SALES SYSTEM</h1>
	</div>
	<hr/>
	...
	<div class="text2" align="center">Copyright &copy; 2017 - 2018  PT REKA SISTEM TEKNOLOGI</div>
	<?php if (isset($error)) { ?>
	<script type="text/javascript">
