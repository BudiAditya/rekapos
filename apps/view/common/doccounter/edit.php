...
<html>
<head>
    <title>REKAPOS - Edit Data Dokumen</title>
...
<fieldset>
    <legend><b>Edit Data Counter Dokumen</b></legend>
    <form id="frm" action="<?php print($helper->site_url("common.doccounter/edit/".$doccounter->Id)); ?>" method="post">
        <input type="hidden" name="Id" id="Id" value="<?php print($doccounter->Id); ?>"/>
