<?php
/** @var $company Company */ /** @var $monthNames string[] */ /** @var $parentAccounts CoaGroup[] */ /** @var $kodeInduk string */
...
$phpExcel->getProperties()->setCreator("Erasys System (c) Budi Aditya")->setTitle("Rekapitulasi Buku Tambahan")->setCompany("Erasystem Infotama Inc");

$sheet = $phpExcel->getActiveSheet();
$sheet->setTitle("Rekapitulasi Buku Tambahan");
...
$sheet->setCellValue("A2", "Rekapitulasi Buku Tambahan");
$sheet->mergeCells("A2:F2");
$sheet->setCellValue("A3", sprintf("Periode: %s %s", $monthNames[$month], $year));
$sheet->mergeCells("A3:F3");
$sheet->setCellValue("A4", sprintf("Akun: %s - %s (Status: %s)", $selectedAccount->KdInduk, $selectedAccount->Kategori, $statusName));
...
header(sprintf('Content-Disposition: attachment;filename="rekapitulasi-buku-tambahan-%s.xls"', $selectedAccount->KdInduk));
