...
WHERE a.user_uid = ?id";
	...
	public function Insert() {
		$this->connector->CommandText =
"INSERT INTO sys_users(is_kasir,is_aktif, user_id, entity_id, cabang_id, user_pwd, user_lvl, user_name, user_email, allow_multiple_login, force_accounting_period, employee_id,a_cabang_id)
VALUES(?is_kasir,?is_aktif, ?user_id, ?entity_id, ?cabang_id, ?user_pwd, ?user_lvl, ?user_name, ?user_email, ?allow_multiple_login, ?force_accounting_period, ?employee_id, ?a_cabang_id)";
        ...
        $this->connector->AddParameter("?is_kasir", $this->IsKasir);
