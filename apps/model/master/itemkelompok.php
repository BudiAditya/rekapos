...
class ItemKelompok extends EntityBase {
	...
	public function Insert() {
		$this->connector->CommandText = 'INSERT INTO m_barang_kelompok(kode,kelompok,keterangan,createby_id,create_time) VALUES(?kode,?kelompok,?keterangan,?createby_id,now())';
		$this->connector->AddParameter("?kode", $this->Kode, "char");
	...
	public function Update($id) {
		$this->connector->CommandText = 'UPDATE m_barang_kelompok SET kode = ?kode, kelompok = ?kelompok, keterangan = ?keterangan, updateby_id = ?updateby_id, update_time = now() WHERE id = ?id';
        $this->connector->AddParameter("?kode", $this->Kode,"char");
		$this->connector->AddParameter("?kelompok", $this->Kelompok);
        $this->connector->AddParameter("?keterangan", $this->Keterangan);
