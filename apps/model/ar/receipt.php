...
class Receipt extends EntityBase {
	...
	public function FillProperties(array $row) {
		...
		$this->WarkatTypeId = $row["receipt_mode"];
	...
	public function Insert() {
		$this->connector->CommandText = "INSERT INTO t_ar_receipt_master(cabang_id, receipt_no, receipt_date, debtor_id, receipt_descs, warkat_type_id, receipt_amount, allocate_amount, receipt_status, createby_id, create_time, no_voucher, warkat_no, warkat_date, warkat_bank_id, warkat_descs, return_no)
VALUES(?cabang_id, ?receipt_no, ?receipt_date, ?debtor_id, ?receipt_descs, ?warkat_type_id, ?receipt_amount, ?allocate_amount, ?receipt_status, ?createby_id, NOW(), ?no_voucher, ?warkat_no, ?warkat_date, ?warkat_bank_id, ?warkat_descs, ?return_no)";
